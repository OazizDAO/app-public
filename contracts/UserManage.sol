...
contract UserManage is OwnableUnset {
    ...
    function createIdentity(bytes32[] memory __keys, string[] memory __values, address identityOwner)
        external onlyOwner
    {
        require(
            identityContracts[identityOwner] == address(0x0),
        ...
        identityContracts[identityOwner] = identity.CitizenshipAddr();
